...
router.post('/v4/do-you-know-nhs-number', function (req, res) {
  ...
  if (know == "Yes"){
    if (nhsNumber != "") {
      res.redirect('/v4/what-is-your-dob')
    } else {
      res.render('v4/do-you-know-nhs-number', {error: 1, noNhsNumber: 1})
    }
  }
  else {
    if (know == "No"){
      ...
      res.redirect('/v4/what-is-your-name')
    } else {
      res.render('v4/do-you-know-nhs-number', {error: 1, noAnswer: 1})
    }
  }
...
// What is your name?
router.post('/v4/what-is-your-name', function (req, res) {
  ...
  if (firstName == ""){
    if (lastName == ""){
      res.render('v4/what-is-your-name', {error: 1, noFirstName: 1, noLastName: 1})
    } else {
      res.render('v4/what-is-your-name', {error: 1, noFirstName: 1})
    }
  } else {
    if (lastName == ""){
      res.render('v4/what-is-your-name', {error: 1, noLastName: 1})
    } else {
      res.redirect('/v4/what-is-your-dob')
    }
  }
...
router.post('/v4/what-is-your-dob', function (req, res) {
  ...
  if (day == ""){
    if (month == ""){
      if (year == ""){
        res.render('v4/what-is-your-dob', {error: 1, noDay: 1, noMonth: 1, noYear: 1})
      } else {
        res.render('v4/what-is-your-dob', {error: 1, noDay: 1, noMonth: 1})
      }
    } else {
      if (year == ""){
        res.render('v4/what-is-your-dob', {error: 1, noDay: 1, noYear: 1})
      } else {
        res.render('v4/what-is-your-dob', {error: 1, noDay: 1})
      }
    }
  } else {
    if (month == ""){
      if (year == ""){
        res.render('v4/what-is-your-dob', {error: 1, noMonth: 1, noYear: 1})
      } else {
        res.render('v4/what-is-your-dob', {error: 1, noMonth: 1})
      }
    } else {
      if (year == ""){
        res.render('v4/what-is-your-dob', {error: 1, noYear: 1})
      } else {
        ...
        if (!(dateRegex.test(year))) {
          ...
          res.redirect('/v4/what-is-your-postcode')
        } else {
          ...
          if (year > currentYearMinusSixteen) {
            // less than sixteen
            res.render('v4/what-is-your-dob', {error: 1, lessThanSixteen: 1})
          } else {
            res.redirect('/v4/what-is-your-postcode')
          }
        }
...
router.post('/v4/what-is-your-postcode', function (req, res) {

  let postcode = req.session.data['postcode']

  if (postcode == ""){
    res.render('v4/what-is-your-postcode', {error: 1, noPostcode: 1})
  } else {
    res.redirect('/v4/accessible-format')
  }
...
router.post('/v4/accessible-format', function (req, res) {

  let checked = req.body['format']

  if (typeof checked == "undefined"){
    res.render('v4/accessible-format', {error: 1, noFormat: 1})
  } else {
    if (checked == "Not requested"){
      res.redirect('/v4/another-language')
    } else {
...
router.post('/v4/another-language', function (req, res) {

  let anotherLanguage = req.session.data['another-language']

  if (typeof anotherLanguage == "undefined"){
    res.render('v4/another-language', {error: 1, noOtherLanguage: 1})
  } else {
    if (anotherLanguage == "Yes"){
      res.redirect('/v4/languages')
    }
    else {
...
router.post('/v4/languages', function (req, res) {

  let language = req.session.data['language']

  if ((typeof language == "undefined") || (language == "")){
    res.render('v4/languages', {error: 1, noLanguage: 1})
  } else {
    res.redirect('/v4/check-your-answers')
  }
...
router.post('/v4/how-would-you-like-to-be-contacted', function (req, res) {

  let contacted = req.session.data['contacted']

  if ((typeof contacted == "undefined") || (contacted == "")){
    res.render('v4/how-would-you-like-to-be-contacted', {error: 1, noContact: 1})
  } else {
    res.redirect('/v4/details-submitted')
  }
